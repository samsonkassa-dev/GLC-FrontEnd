...
function HomePage() {
  ...
  return (
    <>
      <div className="bg-[#F7EDDB] text-black">
        <div className={styles.container}>
          <main className={styles.main}>
            <div className="md:text-[70px] text-[50px] text-center font-black m-0">
              <h1 className="font-fred">
                  Welcome to <span className="text-[#271282]"> Glorious Life </span> <br/> <span className="text-[#e33901]"> Church</span>  Portal!
              </h1>
            </div>
          ...
          <footer className={styles.footer}>
            ...
            >
              <div className="text-[15px] font-bold text-[#333333] leading-tight">
                Powered by Glorious Life Church{" "}
              </div>
